...
sed -i -e '$i \sudo iptables -t nat -I POSTROUTING -o ib0 -s 20.0.0.0/24 -j MASQUERADE &\n' /etc/rc.local
sed -i -e '$i \sudo iptables -I FORWARD -s 20.0.0.0/24 -j ACCEPT &\n' /etc/rc.local
...
sudo iptables -t nat -I POSTROUTING -o ib0 -s 20.0.0.0/24 -j MASQUERADE
sudo iptables -I FORWARD -s 20.0.0.0/24 -j ACCEPT
